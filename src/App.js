...
function App() {
  ...
  const checkMobile = () => {
    ...
    return !!u.match(/Android/i) || (!!u.match(/iPhone/i) && !u.match(/Safari/i));
  };
  ...
  useEffect(() => {
    if (isMobile && checkMobile()) MobileSpeechRecognition.requestPermissions();
  }, []);
          ...
          <div className="microphoneWrapper">
            <div className="container">
              <h1 className="pageTitle">
                {" "}
                <img src={gif}></img>Speech to Text
              </h1>
              <Slider />
              <div className="mic-wrapper">
                ...
                <div className="micField">
                  ...
                  <div className="transcript">{transcript || text}</div>
                </div>
        ...
        <div className="tabs">
          <div className="tablist">
            <button
              className="tab"
              role="tab"
              aria-selected={visibility?.microphone}
              onClick={() => onMenuClickHandler("microphone")}
            >
              <svg
              ...
              >
                <g>
                  <path d="M16,22a6,6,0,0,0,6-6V8A6,6,0,0,0,10,8v8A6,6,0,0,0,16,22Z" />
                  <path d="M25,13a1,1,0,0,0-1,1v2A8,8,0,0,1,8,16V14a1,1,0,0,0-2,0v2a10,10,0,0,0,9,9.95V28H11a1,1,0,0,0,0,2H21a1,1,0,0,0,0-2H17V25.95A10,10,0,0,0,26,16V14A1,1,0,0,0,25,13Z" />
                </g>
              </svg>
              <span></span>
            </button>
            ...
            <button
              className="tab"
              role="tab"
              aria-selected={visibility?.chart}
              onClick={() => onMenuClickHandler("chart")}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
            ...
            <button
              className="tab"
              role="tab"
              aria-selected={visibility?.outlook}
              onClick={() => onMenuClickHandler("outlook")}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 468 468"
                id="outlook"
              >
                <path d="M270.714 121.597V223.05l25.236 21.481 144.429-122.934zM439.717 346.245l-107.909-90.058-25.449 21.661c-5.923 5.042-14.891 5.045-20.818 0l-14.827-12.621v81.017h169.003zM356.625 235.064l111.3 92.889.075-187.689zM119.683 189.649c-23.855 0-34.533 22.401-34.533 44.601 0 25.544 14.307 44.084 34.018 44.084 19.713 0 34.02-18.756 34.02-44.599.001-15.248-7.002-44.086-33.505-44.086z" />
                <path d="M238.595 36.708.002 71.098 0 396.872l238.598 34.417v-.001l.029.003-.032-394.583zM118.142 302.876c-37.345 0-63.427-27.903-63.427-67.855 0-41.165 26.927-69.914 65.483-69.914 37.495 0 63.683 27.902 63.683 67.855 0 48.035-34.077 69.914-65.739 69.914z" />
              </svg>
              <span></span>
            </button>
            <button
              className="tab"
              role="tab"
              aria-selected={visibility?.profile}
              onClick={() => onMenuClickHandler("profile")}
            >
              <svg
                width="16"
                height="20"
